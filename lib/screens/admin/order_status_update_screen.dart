  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarUtils.whiteAppBar(
        title: 'Update Order #${widget.order.id.substring(0, 8).toUpperCase()}',
      ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              widget.order.status.color.withValues(alpha: 0.1),
              widget.order.status.color.withValues(alpha: 0.05),
            ],
          ),
        ),
        child: Column(
